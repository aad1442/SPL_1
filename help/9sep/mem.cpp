...
void displayMemoryInfo(const MemoryInfo& info, int iteration) {
    ...
    std::cout << "Active: " << info.active << " MB\n";
    std::cout << "Inactive: " << info.inactive << " MB\n";
}

// Function to write memory usage information to a file with a timestamp
void writeMemoryInfoToFile(const MemoryInfo& info, int iteration, std::ofstream& outFile) {
    std::string timestamp = getCurrentDateTime();
    outFile << "Memory Usage (Iteration " << iteration << " - " << timestamp << "):\n";
    ...
    outFile << "Active: " << info.active << " MB\n";
    outFile << "Inactive: " << info.inactive << " MB\n";
